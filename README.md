...
3. **Add Environment Variables:**
   ```
   DATABASE_URL=postgresql://emitrr_lwej_user:nTwdk7hiMshYtBrLsP0wPWS227hX9wCg@dpg-d62o5he8alac738jv23g-a.oregon-postgres.render.com/emitrr_lwej
   PORT=10000
   ```
...
3. **Add Environment Variables:**
   ```
   VITE_BACKEND_URL=your-backend-name.onrender.com
   ```
   *(Replace with your actual Render backend URL, without https://)*
...
```bash
cd backend
go build -o connect-four cmd/server/main.go
./connect-four
```
